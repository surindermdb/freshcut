...
function OrderList({ orders, onPrint, onPrintSlips, meta, onPageChange, onSortChange, openNewTab }) {
  ...
  const rowMarkup = allOrders.map(
    ({orderName, orderNameUpdate, customer, shipDate, status, address, id, order, orderId, message, font, design}, index) => (
      <IndexTable.Row
        id={id}
        key={id}
